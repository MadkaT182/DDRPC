return Def.ActorFrame{
	OnCommand=cmd(fov,90;y,210;z,0;rotationx,-5;x,-160;zoomz,0.8;zoomx,1.05),
	GainFocusCommand=cmd(stoptweening;linear,0.2;diffusealpha,1),
	LoseFocusCommand=cmd(stoptweening;linear,0.2;diffusealpha,0),
	-- Def.Quad{
	-- 	OnCommand=cmd(vertalign,bottom;zoomto,100,100;fadetop,1;z,-230*2;y,292;x,-183;rotationy,3;diffuse,1,0.5,0.5,1);
	-- 	GainFocusCommand=cmd(stoptweening;linear,0.2;zoomto,100,100);
	-- 	LoseFocusCommand=cmd(stoptweening;linear,0.2;zoomto,100,0);
	-- },

	-- Def.Quad{
	-- 	OnCommand=cmd(vertalign,bottom;zoomto,100,100;fadetop,1;z,-180;y,252;x,-165;rotationy,3;diffuse,1,0.5,0.5,1);
	-- 	GainFocusCommand=cmd(stoptweening;linear,0.2;zoomto,100,100);
	-- 	LoseFocusCommand=cmd(stoptweening;linear,0.2;zoomto,100,0);
	-- },
